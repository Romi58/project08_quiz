...
function runQuiz() {
    return __awaiter(this, void 0, void 0, function () {
        var inquirer, questions, answers, userAnswers, score;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, import('inquirer')];
                case 1:
                    inquirer = _a.sent();
                    questions = [
                        {
                    ...
                    return [4 /*yield*/, inquirer.default.prompt(questions)];
                case 2:
                    userAnswers = _a.sent();
                    score = 0;
                    ...
                    console.log("\nYour score: ".concat(score, " out of 3\n"));
                    return [2 /*return*/];
            }
        });
    });
